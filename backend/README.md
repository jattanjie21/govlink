...
The open-data REST API for Gambian government datasets, starting with daily exchange rates from the Central Bank of The Gambia. This is the Python side of the [GovLink monorepo](../README.md); the React web client lives in [`../frontend/`](../frontend/).
...
Requires Python 3.12 and [uv](https://docs.astral.sh/uv/). All commands below run from the `backend/` folder.
